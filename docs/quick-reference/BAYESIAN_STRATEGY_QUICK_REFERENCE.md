...
- Full technical docs: `docs/BAYESIAN_STRATEGY.md` (consolidated implementation + workflow)
- This quick reference: `docs/quick-reference/BAYESIAN_STRATEGY_QUICK_REFERENCE.md`
